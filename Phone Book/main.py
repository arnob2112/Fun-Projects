...
class PhoneBook(object):
    def __init__(self, window):
        ...
        self.date_label = Label(self.top_frame, text="Today's date:  " + date, font='arial 10 bold', fg='#878787',
                                bg='#f5f5f5')
        ...
        # view button
        self.my_people_button = Button(self.bottom_frame, width=15, text='My People', font='arial 10 bold',
                                       bg='#b1f0e9',
